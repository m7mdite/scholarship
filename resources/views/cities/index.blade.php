...
<head>
    ...
    <style>
        ...
        .container { max-width: 1000px; margin: 30px auto; background: white; border-radius: 12px; padding: 25px; }
        h1 { color: #1e3a8a; }
...
<div class="container">
    <h1>🏙️ قائمة المدن</h1>
    <a href="{{ route('cities.create') }}" class="btn-add">+ إضافة مدينة جديدة</a>
    ...
    <table>
        <thead>
            <tr><th>#</th><th>اسم المدينة</th><th>الدولة</th><th>الإجراءات</th></tr>
        </thead>
        <tbody>
            @forelse($cities as $city)
                <tr>
                    ...
                    <td class="actions">
                        <a href="{{ route('cities.show', $city->id) }}">عرض</a>
                        <a href="{{ route('cities.edit', $city->id) }}">تعديل</a>
            ...
            @empty
                <tr><td colspan="4">لا توجد مدن بعد.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
