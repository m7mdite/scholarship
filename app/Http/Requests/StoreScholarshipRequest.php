...
class StoreScholarshipRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'application_criteria.age.max' => 'حقل العمر يجب ألا يزيد عن 50 حرفاً.',
            'application_criteria.gender.max' => 'حقل الجنس يجب ألا يزيد عن 50 حرفاً.',
            'application_criteria.nationalities.max' => 'حقل الجنسيات يجب ألا يزيد عن 100 حرف.',
